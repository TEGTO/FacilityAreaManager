...
namespace FacilityAreaManagerApi.Tests
{
    ...
    internal class ExtensionsTests
    {
        ...
        {
            //Act
            services.AddSharedFluentValidation(typeof(ExtensionsTests));
        ...
        {
            // Arrange
            configurationMock.Setup(c => c[Configuration.ALLOWED_CORS_ORIGINS]).Returns(allowedOrigins);
        ...
        {
            // Arrange
            configurationMock.Setup(c => c[Configuration.ALLOWED_CORS_ORIGINS]).Returns("http://example.com");
